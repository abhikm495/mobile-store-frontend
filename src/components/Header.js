  ...
  return (
    <body className="bg-cyan-400">
      <nav className="p-5 bg-white shadow md:flex md:items-center md:justify-between">
        ...
        <ul className="md:flex md:items-center z-[-1] md:z-auto md:static absolute z-10 bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
